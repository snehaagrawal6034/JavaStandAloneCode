public class testing {
        public static void main(String args[]) {
            ...
            System.out.println("Does the array contain the element 4? - " + testing.linearSearch(array, length, 5));
            System.out.println("Does the array contain the element 30? - " + testing.linearSearch(array, length, 30));
        }
